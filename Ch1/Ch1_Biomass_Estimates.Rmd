...
# read in new, updated datasets through 2016
```{r}
# 1. Length-weights (lw)
...
```{r}
chapter1_unmsrd_all <- read_csv("~/GitHub/suisunmarsh/Ch1/Data_output/Data_Ch1_Unmsrd_LW_1995-2016.csv")
```
...
biomass_age0_cpue <- chapter1_biom %>% 
...
# write CSV file
#chapter1_biom %>% 
 # write_csv("~/GitHub/suisunmarsh/Ch1/Data_output/Data_Ch1_BiomassEstimates_1995-2016.csv")
```
